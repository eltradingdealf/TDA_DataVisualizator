...
call C:\DEV\python3\Scripts\pip install --upgrade setuptools
...
call C:\DEV\python3\Scripts\pip install --upgrade click
call C:\DEV\python3\Scripts\pip install --upgrade flask
call C:\DEV\python3\Scripts\pip install --upgrade Flask-RESTful
call C:\DEV\python3\Scripts\pip install --upgrade Flask-Cors
call C:\DEV\python3\Scripts\pip install --upgrade urllib3
